...
class EmployeeController extends Controller
{
    ...
    {
        return view('Admin.employee-table');
    }
    public function get_emp_data()
    {
        $data = DB::table('kmac_employees')
            ->join('kmac_designations','kmac_designations.designation_id','kmac_employees.user_role_id')
    ...
    public function add_employee()
    {
        ...
        return view('Admin.employee-new')->with([
            'result'=>$data,
            'country'=>$country,
            'department'=>$department,
            'designation'=>$designation,
