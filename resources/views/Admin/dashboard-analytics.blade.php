      ...
      <div class="row justify-content-center">
        <div class="col-12">
          <div class="row align-items-center mb-2">
            <div class="col">
              <h2 class="h5 page-title">Welcome to KMAC Dashboard !</h2>
            </div>
            <div class="col-auto">
          ...
          <!-- widgets -->
          <div class="row">
            <div class="col-4 col-sm-12 col-md-4 col-lg-3 mb-4">
              <div class="card shadow">
                <div class="card-body">
                  <div class="row align-items-center">
                    <div class="col">
                      <span class="h2 mb-0 ml-3">{{$employee}}</span>
                      <p class="    mb-0">
                        <a href="{{ route('emp.list') }}" class="nav-link">Employees</a>
                      </p>
            ...
            <div class="col-4 col-sm-12 col-md-4 col-lg-3 mb-4">
              <div class="card shadow">
                <div class="card-body">
                  <div class="row align-items-center">
                    <div class="col">
                      <span class="h2 mb-0 ml-3">{{$inventory}}</span>
                      <p class="  mb-0">
            ...
            <div class="col-4 col-sm-12 col-md-4 col-lg-3 mb-4">
              <div class="card shadow">
                <div class="card-body">
                  <div class="row align-items-center">
                    <div class="col">
                      <span class="h2 mb-0 ml-3">{{$equipments}}</span>
                      <p class="  mb-0">
                        <a href="{{ url('equipment') }}" class="nav-link">Equipments</a>
                      </p>
            ...
            <div class="col-4 col-sm-12 col-md-4 col-lg-3 mb-4">
              <div class="card shadow">
                <div class="card-body">
                  <div class="row align-items-center">
                    <div class="col">
                      <span class="h2 mb-0 ml-3">{{$supplies}}</span>
                      <p class="  mb-0">
                        <a href="{{ url('supplies') }}" class="nav-link">Supplies</a>
                      </p>
            ...
            <div class="col mb-4">
              <div class="card shadow">
                <div class="card-body">
                  <div class="row align-items-center">
                    <div class="col">
                      <span class="h2 mb-0 ml-3">{{$chemicals}}</span>
                      <p class="  mb-0">
                        <a href="{{ url('chemicals') }}" class="nav-link">Chemicals</a>
                      </p>
